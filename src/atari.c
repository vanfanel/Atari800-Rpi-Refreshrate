...
double Atari800_PhysicalRefreshRatePAL = 0;
double Atari800_PhysicalRefreshRateNTSC = 0;
...
static void autoframeskip(double curtime, double lasttime)
{
	...
	if (curtime - afs_lasttime > 0.5) {
		afs_ataritime = ((double) (Atari800_nframes - afs_lastframe)) /
						...
						((double) (Atari800_tv_mode == Atari800_TV_PAL ? Atari800_PhysicalRefreshRatePAL : Atari800_PhysicalRefreshRateNTSC));
...
void Atari800_Sync(void)
{
	...
	double deltatime = 1.0 / ((Atari800_tv_mode == Atari800_TV_PAL) ? Atari800_PhysicalRefreshRatePAL : Atari800_PhysicalRefreshRateNTSC);
